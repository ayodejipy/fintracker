...
async function seedDefaultCategories() {
  ...
  const expenseCategories = [
    ...
    },
    {
      ...
      icon: '📺',
      color: '#06B6D4',
      description: 'Streaming services, software, memberships, recurring subscriptions',
      sortOrder: 9,
    },
    {
      name: 'Shopping',
    ...
    },
    {
      ...
      icon: '💅',
      color: '#EC4899',
      description: 'Haircuts, skincare, hygiene, grooming',
      sortOrder: 11,
    },
    {
      name: 'Pets & Animals',
      ...
      icon: '🐾',
      color: '#F97316',
      description: 'Pet food, vet bills, pet care',
      sortOrder: 12,
    },
    {
      name: 'Family Support',
    ...
    },
    {
      ...
      icon: '✈️',
      color: '#EC4899',
      description: 'Flights, hotels, vacations, trips',
      sortOrder: 20,
    },
    {
      name: 'Miscellaneous',
